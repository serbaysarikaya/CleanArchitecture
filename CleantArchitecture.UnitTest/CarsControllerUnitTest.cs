...
namespace CleantArchitecture.UnitTest
{
    public class CarsControllerUnitTest
    {
        [Fact]
        public async Task Create_ReturnsOkResult_WhenRequestIsVaild()
        {
            // Arrange 
            ...
            var retunValue = Assert.IsType<MessageResponse>(okResult.Value);

            Assert.Equal(response.Message, retunValue.Message);
